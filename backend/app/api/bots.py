    ...
    return {
        ...
        "strategies": {
            "grid": {
                ...
                "expected_daily": "$8-15",
                "risk": "Düşük",
                "entry_example": round(p * 0.99, 2),
                "target_example": round(p * 1.01, 2),
            ...
            "scalping": {
                ...
                "risk": "Orta",
                "entry_example": round(p * 0.999, 2),
                "target_example": round(p * 1.005, 2),
                "stop_example": round(p * 0.995, 2),
                "best_for": "Her piyasa"
            },
            "momentum": {
                "name": "Momentum Bot",
                ...
                "risk": "Yüksek",
                "entry_example": p,
                "target_example": round(p * 1.03, 2),
                "stop_example": round(p * 0.97, 2),
